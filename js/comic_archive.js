...
writeArchive("chapter1",1, 30, 0,true, true); //writeArchive is for listing a RANGE of pages, take advantage of this by using headers to divide them into chapters or by month

writeArchive("chapter2", 31, -1, 0, true, true);

writeArchive("chapter3", 9, 12, 0, true, true);

writeArchive("chapter4", 13, 15, 0, true, true);
